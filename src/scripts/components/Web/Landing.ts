...
export default class Landing {
  ...
  private wellcomeText(): void { this.wellcome = this.scene.add.text(this.bg.x, this.bg.y - 100, this.scene.state.lang.welcomeToFarm, { font: 'Bold 40px Shadow', color: '#925C28', align: 'center', wordWrap: { width: 500 } }).setOrigin(0.5, 1).setDepth(this.bg.depth + 1) }
  ...
  public hide(hide: boolean): void {
    this.elements.forEach(el => { el.setVisible(hide) })
  }

...
export default class MergingCloud {
  ...
  private scene: Sheep | Cow | Unicorn | Chicken | Modal;
  private position: Iposition | Phaser.GameObjects.Sprite | Phaser.Physics.Arcade.Sprite;
  private clouds: Phaser.GameObjects.Group;
  private type: boolean;
  
  constructor(scene: Sheep | Cow | Unicorn | Chicken | Modal, position: Iposition | Phaser.GameObjects.Sprite | Phaser.Physics.Arcade.Sprite, type: boolean = false) {
    this.scene = scene;
  ...
  static create(scene: Sheep | Cow | Unicorn | Chicken | Modal, position: Iposition | Phaser.GameObjects.Sprite | Phaser.Physics.Arcade.Sprite, type: boolean = false): MergingCloud {

...
function autoprogress(load: boolean = false): void {
  ...
  //   else breed = animal.data.values.type;
  ...
  //   if (eggs === 0) {
  //     if (animal.egg + (eggs * wasCollector) > 1000) animal.egg = 1000;
  //     else animal.egg += (eggs * wasCollector);
  //   }
    
  //   if (this.state.userEvent.collector === 0) {
  //     animal.egg = random(0, 1000);
  //   }
  ...
  //     let animal = this.animals.children.entries.find((data: any) => data._id === newEggs[i].id);
  ...
  //     if (newEggs[i].count < animal.diamond) {

  //       animal.diamond -= newEggs[i].count;
  //       count = newEggs[i].count;

  //     } else {

  //       count = 5 - animal.diamond;
  //       animal.destroy();
  ...
  // let speed: number = this.state.chickenCollectorSettings.find((data: IcollectorSettings) => data.level === this.state.userEvent.collectorLevel).speed;

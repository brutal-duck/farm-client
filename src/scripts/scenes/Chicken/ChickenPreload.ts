...
let repository1: any = require("./../../../assets/images/chicken/territories/repository-1.png");
let repository2: any = require("./../../../assets/images/chicken/territories/repository-2.png");
let repository3: any = require("./../../../assets/images/chicken/territories/repository-3.png");
let repository4: any = require("./../../../assets/images/chicken/territories/repository-4.png");
...
class ChickenPreload extends Phaser.Scene {
  ...
  public preload(): void {
    ...
    this.load.image('chicken-repository-1', repository1);
    this.load.image('chicken-repository-2', repository2);
    this.load.image('chicken-repository-3', repository3);
    this.load.image('chicken-repository-4', repository4);
    ...
    this.load.image('chicken-herd-boost-native', herdBoostChickenNative);
  }
    ...
    axios.post(process.env.API + '/chicken/loadData', {
      ...
      // if (response.data.user.chickenSaveCounter >= localSaveCounter) {
        ...
        const chickenSettings: IchickenSettings = {
          ...
          unlockCollector3: response.data.unlockChickenCollector3,
          unlockCollector8: response.data.unlockChickenCollector8,
          unlockCollector15: response.data.unlockChickenCollector15,
          unlockCollector24: response.data.unlockChickenCollector24,
          collectorPrice3: response.data.chickenCollectorPrice3,
          collectorPrice8: response.data.chickenCollectorPrice8,
          collectorPrice15: response.data.chickenCollectorPrice15,
          collectorPrice24: response.data.chickenCollectorPrice24,

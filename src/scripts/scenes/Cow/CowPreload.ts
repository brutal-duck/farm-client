...
let cowLeft_0_2: any = require("./../../../assets/images/cow/cow/cow-left-0-2.png");
let cowLeft_0_3: any = require("./../../../assets/images/cow/cow/cow-left-0-3.png");
let cowLeft_0_4: any = require("./../../../assets/images/cow/cow/cow-left-0-4.png");
let cowRight_0_2: any = require("./../../../assets/images/cow/cow/cow-right-0-2.png");
let cowRight_0_3: any = require("./../../../assets/images/cow/cow/cow-right-0-3.png");
let cowRight_0_4: any = require("./../../../assets/images/cow/cow/cow-right-0-4.png");
...
class CowPreload extends Phaser.Scene {
  ...
  public preload(): void {
    ...
    this.load.spritesheet('cow0', cow0, { frameWidth: 121, frameHeight: 158 });
    this.load.image('cow-left-0-1', pixel);
    this.load.image('cow-left-0-2', cowLeft_0_2);
    this.load.image('cow-left-0-3', cowLeft_0_3);
    this.load.image('cow-left-0-4', cowLeft_0_4);
    this.load.image('cow-right-0-1', pixel);

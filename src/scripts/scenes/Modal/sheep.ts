...
function improveCollectorSheep(): void {
  ...
  let speedText: string = this.state.lang.power + ': ' + thisLevel.speed + ' ' + this.state.lang.unitSheep + '/' + this.state.lang.seconds;
  ...
  if (this.state.userSheep.part >= nextLevel.chapter) {
    ...
    this.clickModalBtn(improve, (): void => {
      ...
      this.updateImproveCollectorSheep(improve, speed, duration, nextLevelText);      
...
function updateImproveCollectorSheep(
  btn: {

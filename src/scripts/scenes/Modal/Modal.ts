...
import { bigButton, repositoryBtn } from '../../elements';
  // буст "Стадо"
import {herdBoostWindow, getRandomSheep, getRandomChicken} from './herdBoostWindow';
...
let tasksWindowSide: any = require("./../../../assets/images/modal/tasks-window-side.png");
let tasksWindowBody: any = require("./../../../assets/images/modal/tasks-window-body.png");

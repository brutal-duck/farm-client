...
export default function typePreload(): void {
    switch (this.state.modal.type) {
      ...
      case 20:
        ...
        this.load.image('clan-window-tab-active-tl', assets.clanWindowTabActiveTL);
        this.load.image('clan-window-tab-active-tc', assets.clanWindowTabActiveTC);
        this.load.image('clan-window-tab-active-tr', assets.clanWindowTabActiveTR);
        this.load.image('clan-window-tab-active-ml', assets.clanWindowTabActiveML);
        this.load.image('clan-window-tab-active-mc', assets.clanWindowTabActiveMC);
        this.load.image('clan-window-tab-active-mr', assets.clanWindowTabActiveMR);
        this.load.image('clan-window-tab-active-bl', assets.clanWindowTabActiveBL);
        this.load.image('clan-window-tab-active-bc', assets.clanWindowTabActiveBC);
        this.load.image('clan-window-tab-active-br', assets.clanWindowTabActiveBR);
        this.load.image('clan-window-tab-disable', assets.clanWindowTabDisable);
        this.load.image('clan-window-tab-disable-tl', assets.clanWindowTabDisableTL);
        this.load.image('clan-window-tab-disable-tc', assets.clanWindowTabDisableTC);
        this.load.image('clan-window-tab-disable-tr', assets.clanWindowTabDisableTR);
        this.load.image('clan-window-tab-disable-ml', assets.clanWindowTabDisableML);
        this.load.image('clan-window-tab-disable-mc', assets.clanWindowTabDisableMC);
        this.load.image('clan-window-tab-disable-mr', assets.clanWindowTabDisableMR);
        this.load.image('clan-window-tab-disable-bl', assets.clanWindowTabDisableBL);
        this.load.image('clan-window-tab-disable-bc', assets.clanWindowTabDisableBC);
        this.load.image('clan-window-tab-disable-br', assets.clanWindowTabDisableBR);
        ...
        this.load.image('clan-window-search-plate-ns', assets.clanWindowSearchPlate);
        this.load.image('clan-window-leader-plate-ns', assets.clanWindowLeaderPlateSliced);

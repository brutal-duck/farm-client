...
function getTerritoryType(data: Iterritories): string {
  ...
  if (data.type === 0) type = 'sheep-for-buying';
  else if (data.type === 1) type = 'sheep-bought';
  else if (data.type === 2) {
  ...
  } else if (data.type === 4) type = 'sheep-merging';
  else if (data.type === 5) type = 'sheep-repository';
  else if (data.type === 6) type = 'sheep-house';
  else if (data.type === 7) type = 'sheep-ground';
  else if (data.type === 8) type = 'sheep-repository';

const basicCowFarm = [
  ...
  { animalCount: 1, animalBreed: 2, fairLevel: 1, territoryCount: 5 + 3 }, // 2
  { animalCount: 2, animalBreed: 2, fairLevel: 1, territoryCount: 6 + 3 }, // 3
  { animalCount: 2, animalBreed: 3, fairLevel: 2, territoryCount: 6 + 3 }, // 4
  { animalCount: 4, animalBreed: 4, fairLevel: 3, territoryCount: 6 + 3 }, // 5
  { animalCount: 4, animalBreed: 5, fairLevel: 4, territoryCount: 7 + 3 }, // 6
  { animalCount: 4, animalBreed: 6, fairLevel: 5, territoryCount: 8 + 3 }, // 7
  { animalCount: 6, animalBreed: 6, fairLevel: 5, territoryCount: 9 + 3 }, // 8
...
const fullCowTerritories = [
  ...
  { _id: 'local_31', block: 3, position: 1, type: 8, volume: 0, improve: 1, money: 0, cooldown: 0, boughtType: 0, },
...
export { basicCowFarm, fullCowTerritories };
